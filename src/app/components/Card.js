export default function Card({
  ...
  return (
    <div className="flex-grow-1 flex-wrap justify-around text-center block p-10 bg-slate-800 rounded-2xl border border-black shadow-xl hover:scale-[1.1] transition-transform">
